...
describe(".agregarProducto",()=>{
    ...
    it ("Debería agregra al carrito el producto con nombre, precio y cantidad", ()=>{
        ...
        let miCarrito=new CarritoCompra ();
        let product={name:"papas fritas",price:2.50,quantity:3};
    ...
    it ("Se pueden agregar varios productos del mismo tipo a la vez.", ()=>{
        ...
        let miCarrito=new CarritoCompra ();
        let p1={name:"papas fritas",price:2.50,quantity:3};
        let p2={name:"hamburguesa",price:6.50,quantity:4};
    ...
    it("Si el producto ya existe en el carrito, se sume su cantidad actual a la nueva cantidad.", ()=>{
        let miCarrito=new CarritoCompra();
        miCarrito.agregarProducto({name:"papas fritas",price:2.50,quantity:1});
        miCarrito.agregarProducto({name:"papas fritas",price:2.50,quantity:1});
...
describe(".calcularTotal",()    => {
    it("Devuelve el monto total de la compra.", ()=>{
       let miCarrito = new CarritoCompra();
       miCarrito.agregarProducto ({ name : "Papas Fritas" , price : 2.50 , quantity : 2}) ;
       miCarrito.agregarProducto ({ name : "Hamburguesa" , price : 6.50 , quantity : 1}) ;
       expect(miCarrito.calcularTotal()).toBe(11.50) ;
    } ) ;
} ) ;
